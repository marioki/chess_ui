...
class BoardSquare extends StatelessWidget {
  const BoardSquare({
    ...
    required this.squareBackgroundColor,
  ...
  final Color squareBackgroundColor;
        ...
        return Stack(
          children: [
            Container(
              ...
              child: (squareData.coordinate.file == 0 ||
                      squareData.coordinate.rank == 0)
                  ? Align(
